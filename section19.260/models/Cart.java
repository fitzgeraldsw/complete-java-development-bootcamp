...
public class Cart {
    ...
    */
    public boolean add(Item item) {
        // contains method calls equals method, in this case our overloaded equals method
        // FALSE means that item was NOT added
        if (this.items.contains(item)) {
            return false;
        }
        // TRUE means that item was added
        // this add method is from ArrayList
    ...
    */
    public String checkout() {
        ...
        for (int i = 0; i < this.items.size(); i++) {
            measures[0] += this.items.get(i).getPrice();  // pre-tax price
        }

        measures[1] = measures[0] * 0.13; // price after tax
